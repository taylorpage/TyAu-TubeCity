//
//  TubeCityExtensionAUProcessHelper.hpp
//  TubeCityExtension
//
...
#include "TubeCityExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(TubeCityExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
...
private:
    TubeCityExtensionDSPKernel& mKernel;
